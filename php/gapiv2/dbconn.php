...
include_once __DIR__ . "/../feedbackconfig.php";

// Create a global $gapiconn exists for the MySQL connection
global $gapiconn;
$gapiconn = new mysqli($feedbackconfig["server"], $feedbackconfig["username"], $feedbackconfig["password"], $feedbackconfig["database"]);
